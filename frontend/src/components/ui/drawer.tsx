 ...
 * Drawer Component
 *
 * Slide-out panel built on Vaul for mobile-friendly bottom sheets
 * and side drawers. Features smooth spring animations.
 *
 * @example
 * <Drawer>
  ...
  <DrawerPortal>
    ...
    <DrawerPrimitive.Content
      ...
      className={cn(
        ...
        "mt-24 flex h-auto max-h-[96vh] flex-col",
        "rounded-t-2xl",
